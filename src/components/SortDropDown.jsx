  ...
  return (
    <div className="flex justify-center">
      <details className="relative">
        <summary className="px-4 py-2 text-xs text-gray-100 border border-blue-500 rounded-full hover:bg-blue-800 transition">
          <Funnel size={14} className="text-blue-400" /> Sort: {selectedSort || "Select"}
        </summary>
