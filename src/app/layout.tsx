            ...
            <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden md:flex items-center space-x-4">
                ...
                <div className="ml-4 relative">
                  <Link href="/profile" className="flex items-center justify-center w-8 h-8 bg-blue-700 rounded-full hover:bg-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-300 focus:ring-offset-2 focus:ring-offset-blue-600">
